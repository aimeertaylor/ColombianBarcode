...
# Access
mle_CIs$Coast <- LonLats[mle_CIs$City1, "CoastAccess"] == 1 & LonLats[mle_CIs$City2, "CoastAccess"] == 1
mle_CIs$Port <- LonLats[mle_CIs$City1, "Port"] == 1 & LonLats[mle_CIs$City2, "Port"] == 1
