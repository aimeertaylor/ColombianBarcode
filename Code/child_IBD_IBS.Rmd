...
# Load FST results (for comparison of FST to IBD)
...
# Buenaventura Tumaco
points(x = pairwise_site_distance$distance[6], y = pairwise_site_distance$travel_time[6], pch = 1, cex = 2)
