...
write.table(HMMData, file = '/Users/aimeet/Documents/BroadLaptop/ColombianData/HMMData.txt', 
            quote = FALSE, row.names = FALSE, sep = '\t')
save(SNPData, file = '/Users/aimeet/Documents/BroadLaptop/ColombianData/SNPData.RData')
